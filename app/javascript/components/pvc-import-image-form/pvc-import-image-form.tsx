...
import createSchema from "./pvc-import-image-form.schema";
import type {
  OptionType,
  ProvidersResponse,
  ...
  FormValues,
  FormOptions,
} from "./pvc-import-image-form-types";
...
const PvcImportImageForm: React.FC = () => {
...
export default PvcImportImageForm;
